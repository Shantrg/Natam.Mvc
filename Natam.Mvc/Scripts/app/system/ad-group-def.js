...
function app_ad_group_def(userInfo) {
    ...
    this.gridWith = 500;
    this.sourceData = {};
    this.sourceUrl = '/Admin/AdGroupDefList';
    this.updateUrl = '/Admin/AdGroupDefUpdate';
    this.deleteUrl = '/Admin/AdDefDelete';
    this.showMemmbersUrl = '/Admin/AdGroupShowMembers';
    this.fieldId = 'GroupId';
    this.RelUrl = '/Admin/AdGroupDefRel';
    this.RelToAddUrl = '/Admin/AdGroupDefRelToAdd';
    this.RelDeleteUrl = "/Admin/AdGroupDefRelDelete"
    this.RelUpdateUrl = "/Admin/AdGroupDefRelUpdate"
    this.rowEdit = -1;
    ...
    this.nastedGridLoder = function (id, all) {
        ...
        if (all == false) {
            src._source.url = this.RelUrl;//'/Admin/AdDefRel';
            ...
            src._source.url = this.RelToAddUrl;// '/Admin/AdDefRelToAdd';
            src._source.data = { 'id': id };
            $('#jqxgrid2').jqxGrid('source').dataBind();
...
app_ad_group_def.prototype.loadControls = function () {
...
app_ad_group_def.prototype.nastedGrid = function (id) {
